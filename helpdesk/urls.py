...
urlpatterns = [
    ...
    path('list-tickets.html', views.ListTickets.as_view(), name='list-tickets'),
    ...
    path('list-tickets-admin.html', views.ListTicketsAdmin.as_view(), name='list_tickets_admin'),
    path('list-completed-tickets-admin.html', views.ListCompletedTicketsAdmin.as_view(),
         name='list-completed-tickets'),
